...
class HomeScreen extends StatelessWidget {
    ...
    return AppBar(
      ...
      title: Row(
        children: [
          ...
          _buildFreeModelsDisplay(context),
                      ...
                      children: [
                        ...
                        Text(
                          chatProvider.formatPricing(
                            double.tryParse(model['pricing']?['prompt']) ?? 0.0,
                          ),
          ...
          child: Row(
            children: [
              ...
              Text(
                ...
                style: const TextStyle(color: Color(0xFF33CC33), fontSize: 12),
              ),
            ],
          ),
        );
  ...
  Widget _buildFreeModelsDisplay(BuildContext context) {
    return Consumer<ChatProvider>(
      builder: (context, chatProvider, child) {
        return Padding(
          padding: const EdgeInsets.symmetric(horizontal: 3.0),
          child: Row(
            children: [
              Icon(Icons.model_training, size: 12, color: Colors.white70),
              const SizedBox(width: 4),
              Text(
                'Бесплатных: ${chatProvider.freeModelsCount}',
                style: const TextStyle(color: Color(0xFF33CC33), fontSize: 12),
              ),
            ],
          ),
